...
if st.sidebar.button("Predict"):
  if classifier == "Logistic Regression":
    species_type = prediction(log_reg,isl,b_length,b_depth,f_length,body_mass,sex)
    score = log_reg.score(X_train,y_train)

  elif  classifier == "Random Forest Classifier":
    species_type = prediction(rf_clf,isl,b_length,b_depth,f_length,body_mass,sex)
    score = rf_clf.score(X_train,y_train)

  elif  classifier == "Support Vector Machine":
    species_type = prediction(svc_model,isl,b_length,b_depth,f_length,body_mass,sex)
